            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="d-flex justify-content-end">
                            <div class="cms-seo-container">
                                <div class="cms-seo-preview">
                                    <div class="d-flex mb-3">
                                        <svg fill="none" viewBox="0 0 92 31">
                                            <path d="M39.15 15.898c0 4.303-3.378 7.473-7.525 7.473s-7.526-3.17-7.526-7.473c0-4.334 3.38-7.474 7.526-7.474 4.147 0 7.526 3.14 7.526 7.474zm-3.294 0c0-2.69-1.958-4.529-4.231-4.529-2.273 0-4.231 1.84-4.231 4.529 0 2.662 1.958 4.528 4.231 4.528 2.273 0 4.231-1.87 4.231-4.528z" fill="#EA4335"></path>
                                            <path d="M55.386 15.898c0 4.303-3.379 7.473-7.526 7.473-4.146 0-7.526-3.17-7.526-7.473 0-4.33 3.38-7.474 7.526-7.474 4.147 0 7.526 3.14 7.526 7.474zm-3.294 0c0-2.69-1.959-4.529-4.232-4.529s-4.231 1.84-4.231 4.529c0 2.662 1.958 4.528 4.231 4.528 2.273 0 4.232-1.87 4.232-4.528z" fill="#FBBC05"></path>
                                            <path d="M70.945 8.875v13.418c0 5.52-3.267 7.774-7.13 7.774-3.636 0-5.825-2.423-6.65-4.404l2.868-1.19c.511 1.217 1.763 2.652 3.779 2.652 2.472 0 4.004-1.52 4.004-4.38V21.67h-.115c-.737.906-2.158 1.698-3.95 1.698-3.751 0-7.188-3.255-7.188-7.443 0-4.22 3.437-7.501 7.188-7.501 1.789 0 3.21.792 3.95 1.671h.115V8.88h3.129v-.004zm-2.895 7.05c0-2.632-1.763-4.556-4.005-4.556-2.273 0-4.177 1.924-4.177 4.556 0 2.604 1.904 4.501 4.177 4.501 2.242 0 4.005-1.897 4.005-4.501z" fill="#4285F4"></path>
                                            <path d="M76.103 1.01v21.903H72.89V1.011h3.213z" fill="#34A853"></path>
                                            <path d="M88.624 18.357l2.558 1.699c-.826 1.216-2.815 3.312-6.251 3.312-4.262 0-7.445-3.282-7.445-7.474 0-4.444 3.21-7.473 7.076-7.473 3.893 0 5.798 3.086 6.42 4.754l.341.85-10.028 4.137c.768 1.5 1.962 2.264 3.636 2.264 1.678 0 2.841-.822 3.693-2.069zm-7.87-2.688l6.703-2.774c-.368-.933-1.478-1.583-2.783-1.583-1.674 0-4.005 1.472-3.92 4.357z" fill="#EA4335"></path>
                                    ...
                                    <div class="cms-seo-preview-title" data-seo-text="#seo_meta_title">Website title preview here</div>
                                    <div class="cms-seo-preview-desc" data-seo-text="#seo_meta_description">Website description preview here</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        @mediafile(['name' => 'seo_meta_og_image', 'label' => __('seo::meta.og_image')])
                    </div>
                    <div class="col-md-7">
                        <div class="d-flex justify-content-center">
                            <div class="cms-preview cms-og-container">
                                <div class="d-flex mx-3 mt-3 mb-2">
                                    <span>
                                        <svg fill="none" viewBox="0 0 40 40" class="social-icon">
                                    ...
                                    <div>
                                        <div class="cms-social-og-title">{{ setting('site_title_short') }}</div>
                                        <div class="cms-social-og-time">12 hrs</div>
                                    </div>
                                </div>
                                <div class="d-flex flex-column mx-3 mb-3">
                                    <span class="cms-social-og-desc w-100 mb-2"></span>
                                    <span class="cms-social-og-desc w-75"></span>
                                </div>
                                <div class="cms-social-og-preview">
                                    <div class="cms-social-og-preview-image"
                                         data-seo-image="seo_meta_og_image"
                                         style="display: none;"></div>
                                    <div class="cms-social-og-preview-bookmark">
                                        <div class="cms-social-og-preview-content">
                                            <div class="cms-social-og-preview-meta">
                                                {{ url('/') }}
                                            </div>
                                            <div class="cms-social-og-preview-title" data-seo-text="#seo_meta_og_title">Website title preview here</div>
                                            <div class="cms-social-og-preview-desc" data-seo-text="#seo_meta_og_description">Website description preview here</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="cms-social-og-reactions">
                                    <span class="cms-social-og-likes">
                                        <svg fill="none" viewBox="0 0 30 30" class="z-999">
                                            <path d="M15 27c6.627 0 12-5.373 12-12S21.627 3 15 3 3 8.373 3 15s5.373 12 12 12z" fill="#5E92FF"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M30 15c0 8.284-6.716 15-15 15-8.284 0-15-6.716-15-15C0 6.716 6.716 0 15 0c8.284 0 15 6.716 15 15zm-3 0c0 6.627-5.373 12-12 12S3 21.627 3 15 8.373 3 15 3s12 5.373 12 12z" fill="#fff"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M9.246 14.078h2.13c.17 0 .304.135.304.305v6.13c0 .17-.134.304-.304.304h-2.13a.31.31 0 01-.313-.305v-6.13a.31.31 0 01.313-.304zm3.687 5.88h6.506a.869.869 0 00.867-.868.887.887 0 00-.554-.806h.16c.457 0 .833-.501.833-.957a.838.838 0 00-.832-.842h-.161v-.071h.465a.844.844 0 00.841-.832.846.846 0 00-.841-.841h-.465v-.072h.465a.844.844 0 00.841-.832.846.846 0 00-.841-.841h-3.642c-.027-.01-.027-.036 0-.09.045-.09.143-.268.295-.537.152-.268.34-.617.439-1.065.098-.447.09-.993.009-1.423-.072-.42-.224-.733-.412-.93a.954.954 0 00-.653-.296c-.233-.008-.475.054-.645.206-.17.161-.259.403-.304.716-.036.322-.009.716-.018.958-.018.241-.062.34-.214.456-.161.116-.421.268-.663.474a5.221 5.221 0 00-.698.797c-.376.483-1.315 1.7-1.315 2.219v4.94c0 .295.242.537.537.537z" fill="#FEFEFE"></path>
                                        </svg>
                                        <svg fill="none" viewBox="0 0 30 30" class="ml-n1">
                                            <path d="M15 27c6.627 0 12-5.373 12-12S21.627 3 15 3 3 8.373 3 15s5.373 12 12 12z" fill="#FF4F67"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M30 15c0 8.284-6.716 15-15 15-8.284 0-15-6.716-15-15C0 6.716 6.716 0 15 0c8.284 0 15 6.716 15 15zm-3 0c0 6.627-5.373 12-12 12S3 21.627 3 15 8.373 3 15 3s12 5.373 12 12z" fill="#fff"></path>
                                            <path d="M14.5 11.441C15.434 9.811 16.375 9 18.25 9 20.317 9 22 11.49 22 13.28c0 3.252-4.484 6.777-7.5 8.72-2.713-1.678-7.5-5.468-7.5-8.72C7 11.49 8.684 9 10.75 9c1.875 0 2.809.811 3.75 2.441z" fill="#FEFEFE"></path>
                                        </svg>
                                        182
                                    </span>
                                    <span class="cms-social-og-comments">7 comments</span>
                                    <span class="cms-social-og-comments ml-2">2 shares</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        @mediafile(['name' => 'seo_meta_twitter_image', 'label' => __('seo::meta.twitter_image')])
                    </div>
                    <div class="col-md-7">
                        <div class="d-flex justify-content-center">
                            <div class="cms-preview cms-twitter-container">
                                ...
                                <span>
                                    ...
                                    <div class="w-100">
                                        <span class="cms-social-og-title">{{ setting('site_title_short') }}</span>
                                        <span class="cms-social-og-time">12 hrs</span>
                                        <div class="d-flex flex-column mt-2 mb-3">
                                            <span class="cms-social-og-desc w-100 mb-2"></span>
                                            <span class="cms-social-og-desc w-75"></span>
                                        </div>
                                        <div class="cms-social-twitter-post-preview">
                                            <div class="cms-social-twitter-preview-image"
                                                 data-seo-image="seo_meta_twitter_image"
                                                 style="display: none;"></div>
                                            <div class="cms-social-twitter-preview-content">
                                                <div class="cms-social-twitter-preview-title" data-seo-text="#seo_meta_twitter_title">Website title preview here</div>
                                                <div class="cms-social-twitter-preview-desc" data-seo-text="#seo_meta_twitter_description">Website description preview here</div>
                                                <div class="cms-social-twitter-preview-meta">
                                                    <svg viewBox="0 0 24 24">
                                                        <path d="M11.96 14.945a.833.833 0 01-.203-.027 5.192 5.192 0 01-2.795-1.932c-.832-1.125-1.176-2.508-.968-3.893s.942-2.605 2.068-3.438l3.53-2.608a5.25 5.25 0 017.33 1.1c.83 1.127 1.175 2.51.967 3.895s-.943 2.605-2.07 3.438l-1.48 1.094a.752.752 0 01-.892-1.208l1.48-1.095a3.713 3.713 0 001.476-2.45 3.724 3.724 0 00-.69-2.778 3.745 3.745 0 00-5.23-.784l-3.53 2.608a3.72 3.72 0 00-1.475 2.45c-.15.99.097 1.975.69 2.778a3.701 3.701 0 001.992 1.377.752.752 0 01-.202 1.475z" fill="#5b7083"></path>
                                                        <path d="M7.27 22.054a5.24 5.24 0 01-5.193-6.019 5.21 5.21 0 012.07-3.438l1.478-1.094a.752.752 0 01.893 1.208l-1.48 1.095a3.716 3.716 0 00-1.475 2.45c-.148.99.097 1.975.69 2.778a3.745 3.745 0 005.23.785l3.528-2.608a3.744 3.744 0 00.785-5.23 3.7 3.7 0 00-1.992-1.376.75.75 0 01-.52-.927c.112-.4.528-.63.926-.522a5.19 5.19 0 012.794 1.932 5.248 5.248 0 01-1.1 7.33l-3.53 2.608a5.189 5.189 0 01-3.105 1.026z" fill="#5b7083"></path>
                                                    </svg>
                                                    {{ url('/') }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="cms-social-twitter-reactions">
