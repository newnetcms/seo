@php
    ...
    $seoDescriptionFallback = object_get($item ?? null, 'description') ?: setting('seo_meta_description');
    $seoOgTitleFallback = setting('seo_meta_og_title') ?: setting('seo_meta_title');
    $seoOgDescriptionFallback = setting('seo_meta_og_description') ?: setting('seo_meta_description');
    $seoOgImageFallback = get_setting_media_url('seo_meta_og_image');
    $seoTwitterTitleFallback = setting('seo_meta_twitter_title') ?: setting('seo_meta_title');
    $seoTwitterDescriptionFallback = setting('seo_meta_twitter_description') ?: setting('seo_meta_description');
    $seoTwitterImageFallback = get_setting_media_url('seo_meta_twitter_image');
@endphp
            ...
            <div class="seo-preview-card">
                ...
                <div class="seo-preview-card-body">
                    <div class="cms-seo-preview">
                        ...
                        <div class="cms-seo-preview-title" data-seo-text="[name='seometa[title]']" data-seo-text-fallback="[name='name']" data-placeholder="{{ __('seo::setting.preview.title_placeholder') }}"></div>
                        <div class="cms-seo-preview-desc" data-seo-text="[name='seometa[description]']" data-seo-text-fallback="[name='description']" data-seo-static-fallback="{{ $seoDescriptionFallback }}" data-placeholder="{{ __('seo::setting.preview.description_placeholder') }}"></div>
                    </div>
                </div>
                <div class="seo-preview-card-footer">
                    <span class="seo-char-counter" data-seo-counter="[name='seometa[title]']" data-limit="60">
                        {{ __('seo::meta.title') }}: <span class="seo-char-counter-value">0</span>/60
                    </span>
                    <span class="seo-char-counter" data-seo-counter="[name='seometa[description]']" data-limit="160">
            ...
            <div class="seo-preview-card">
                ...
                <div class="seo-preview-card-body">
                    <div class="cms-og-preview">
                        <div class="cms-og-preview-image is-empty" data-seo-image="seometa[og_image]" data-seo-image-fallback="image" data-seo-image-static-fallback="{{ $seoOgImageFallback }}">
                        ...
                        <div class="cms-og-preview-body">
                            ...
                            <div class="cms-og-preview-title" data-seo-text="[name='seometa[og_title]']" data-seo-text-fallback="[name='seometa[title]']||[name='name']" data-seo-static-fallback="{{ $seoOgTitleFallback }}" data-placeholder="{{ __('seo::setting.preview.title_placeholder') }}"></div>
                            <div class="cms-og-preview-desc" data-seo-text="[name='seometa[og_description]']" data-seo-text-fallback="[name='seometa[description]']||[name='description']" data-seo-static-fallback="{{ $seoOgDescriptionFallback }}" data-placeholder="{{ __('seo::setting.preview.description_placeholder') }}"></div>
                        </div>
                    </div>
                </div>
                <div class="seo-preview-card-footer">
                    <span class="seo-char-counter" data-seo-counter="[name='seometa[og_title]']" data-limit="60">
                        {{ __('seo::meta.og_title') }}: <span class="seo-char-counter-value">0</span>/60
                    </span>
                    <span class="seo-char-counter" data-seo-counter="[name='seometa[og_description]']" data-limit="110">
            ...
            <div class="seo-preview-card">
                ...
                <div class="seo-preview-card-body">
                    <div class="cms-twitter-preview">
                        <div class="cms-twitter-preview-image is-empty" data-seo-image="seometa[twitter_image]" data-seo-image-fallback="image" data-seo-image-static-fallback="{{ $seoTwitterImageFallback }}">
                            <span class="cms-preview-image-placeholder"><i class="fas fa-image"></i> {{ __('seo::setting.preview.no_image') }}</span>
                        </div>
                        <div class="cms-twitter-preview-body">
                            <div class="cms-twitter-preview-title" data-seo-text="[name='seometa[twitter_title]']" data-seo-text-fallback="[name='seometa[title]']||[name='name']" data-seo-static-fallback="{{ $seoTwitterTitleFallback }}" data-placeholder="{{ __('seo::setting.preview.title_placeholder') }}"></div>
                            <div class="cms-twitter-preview-desc" data-seo-text="[name='seometa[twitter_description]']" data-seo-text-fallback="[name='seometa[description]']||[name='description']" data-seo-static-fallback="{{ $seoTwitterDescriptionFallback }}" data-placeholder="{{ __('seo::setting.preview.description_placeholder') }}"></div>
                ...
                <div class="seo-preview-card-footer">
                    <span class="seo-char-counter" data-seo-counter="[name='seometa[twitter_title]']" data-limit="70">
                        {{ __('seo::meta.twitter_title') }}: <span class="seo-char-counter-value">0</span>/70
                    </span>
                    <span class="seo-char-counter" data-seo-counter="[name='seometa[twitter_description]']" data-limit="200">
